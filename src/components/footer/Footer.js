...
export function Footer() {
  return (
    <Container>
      <Row className="mb-5">
        <Col className="mt-5" xs={12} sm={12} md={12} lg={6} xl={6}>
          <div className="addresses">
            <div className="addresses-item">
              <svg
                ...
                height="20"
                fill="currentColor"
                className="bi bi-clock-fill text-white"
                viewBox="0 0 16 16"
              >
            ...
            <div className="addresses-item">
              <svg
                ...
                height="20"
                fill="currentColor"
                className="bi bi-pin-map-fill text-white"
                viewBox="0 0 16 16"
              >
                <path
                  fillRule="evenodd"
            ...
            <div className="addresses-item">
              <svg
                ...
                height="20"
                fill="currentColor"
                className="bi bi-mailbox2 text-white"
                viewBox="0 0 16 16"
              >
